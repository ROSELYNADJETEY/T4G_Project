...
const PRODUCTS = [
  ...
  },
  {
    ...
    brand: 'Mingle & Glow Cosmetics',
    skinTypes: ['Dry', 'Normal'],
    image: '../images/hydra-moisturizer.avif'
  },
  {
    id: 'perfume1',
    name: 'Niver',
  ...
  },
  {
    ...
    brand: 'Mingle & Glow Cosmetics',
    fragranceType: 'Citrus',
    image: '../images/citrus_perfume.jpg'
  },
  {
    id: 'perfume4',
    name: 'Cream Essence',
...
document.addEventListener("DOMContentLoaded", () => {
  updateCartBadge();
  initFilters();
  displayCart(); // 🔥 THIS FIXES YOUR ISSUE
});
